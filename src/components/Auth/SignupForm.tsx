...
export default function SignupForm() {
  ...
  return (
    <form onSubmit={handleSignup} className="space-y-6 max-w-md mx-auto">
      ...
      <CustomButton btnType="submit" isDisabled={loading} containerStyles="w-full bg-green-600 hover:bg-green-700 text-white py-4 rounded-xl font-black" title={loading ? "Creating..." : "Create Account"} />
