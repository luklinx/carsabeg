  ...
  return (
    <>
      ...
      <CustomButton
        ...
        containerStyles="lg:hidden z-50 p-2 rounded-lg transition-all"
        ...
        <>
          ...
          <nav className="fixed top-0 right-0 bottom-0 w-80 bg-white z-50 flex flex-col shadow-2xl overflow-y-auto">
            ...
            <div className="flex justify-between items-center p-6 border-b border-gray-100 sticky top-0 bg-white">
              ...
              <CustomButton
                onClick={closeMenu}
                containerStyles="p-1 rounded-lg hover:bg-gray-100"
            ...
            <div className="flex-1 py-6">
              ...
              <div>
                <CustomButton
                  ...
                  containerStyles="w-full flex items-center justify-between gap-4 px-6 py-3 text-lg font-bold text-gray-800 hover:bg-green-50 hover:text-green-600 transition-all border-l-4 border-transparent hover:border-green-600"
                >
            ...
            {/* Footer */}
            <p className="text-center text-gray-600 font-semibold text-xs pb-4 px-4">
