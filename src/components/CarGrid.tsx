...
import type { ComponentCarGridProps } from "@/types";
    ...
    return (
      <div className="py-20 text-center">
        <div className="bg-gray-100 border-2 border-dashed border-gray-300 rounded-3xl w-32 h-32 mx-auto mb-8 flex items-center justify-center">
          <svg
            className="w-w-16 h-16 text-gray-600"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
    ...
    <section className="py-8 md:py-12">
      ...
      {cars.length > 12 && (
        <div className="text-center mt-16">
          <CustomButton
            containerStyles="bg-white border-2 border-gray-300 hover:border-green-600 text-gray-800 hover:text-green-600 font-black text-lg px-10 py-4 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl"
