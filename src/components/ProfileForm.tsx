    ...
    <div className="max-w-2xl mx-auto space-y-10">
      <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
        ...
        <div className="mb-10">
          ...
          <div className="flex items-center gap-8">
            ...
            <div>
              <label className="cursor-pointer">
                ...
                />
                <div
                  className={`px-10 py-5 rounded-2xl font-black text-xl transition-all shadow-xl inline-block ${
                    uploading
          ...
          {message && (
            <div
              className={`mt-6 p-4 rounded-xl text-center font-bold text-lg border ${
        ...
        <button className="w-full mt-12 bg-black hover:bg-gray-900 text-white py-6 rounded-2xl font-black text-2xl shadow-2xl transition-all hover:scale-105">
